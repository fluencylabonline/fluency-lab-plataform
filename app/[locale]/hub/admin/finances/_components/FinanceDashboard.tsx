...
export function FinanceDashboard({
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Filters & Actions */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-card p-4 rounded-md border border-border shadow-xs md:sticky md:top-12 md:z-30">
