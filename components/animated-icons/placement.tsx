...
export interface PlacementIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface PlacementIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}

const PlacementIcon = forwardRef<PlacementIconHandle, PlacementIconProps>(
