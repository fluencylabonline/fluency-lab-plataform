...
export const createRecurrenceRulesBatchSchema = z.object({
  rules: z.array(createRecurrenceRuleSchema),
});

export type CreateRecurrenceRulesBatchValues = z.input<typeof createRecurrenceRulesBatchSchema>;
