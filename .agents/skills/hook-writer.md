...
4. **Loading & Feedback:** Sempre exponha estados de carregamento (`isLoading`, `isMutating`) para que a UI possa reagir com spinners ou skeletons (veja @/.agents/skillks/shimmer-skeleton.md).
